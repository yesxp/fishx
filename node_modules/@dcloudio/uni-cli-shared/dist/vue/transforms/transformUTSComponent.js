...
exports.transformUTSComponent = exports.UTS_CUSTOM_ELEMENT_IMPORT_PLACEHOLDER = void 0;
const ast_1 = require("../../vite/utils/ast");
const utsUtils_1 = require("../../utsUtils");
const uts_1 = require("../../uts");
exports.UTS_CUSTOM_ELEMENT_IMPORT_PLACEHOLDER = '__UTS_CUSTOM_ELEMENT_IMPORT_PLACEHOLDER__';
/**
 * 将uts组件保存到自定义组件列表中
 * @param node
 * @param context
